...
$profession = "cat";
$city = "Moscow";
$e_mail = "moew@catmail.com";
$phone_number = "+79331234567";
...
$experience = [
    ...
    [
        'job title' => 'Web Developer / something.com',
        'date start' => 'Mar 2012',
        'date end' => 'Dec 2014',
        'description' => 'Lorem ipsum dolor sit amet. Praesentium magnam consectetur vel in deserunt aspernatur est reprehenderit sunt hic. Nulla tempora soluta ea et odio, unde doloremque repellendus iure, iste.',
    ],
    [
        'job title' => 'Graphic Designer / designsomething.com',
        'date start' => 'Jun 2010',
        'date end' => 'Mar 2012',
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
              ...
              <?php for ($i = 0; $i < count($experience); $i ++): ?>
                <div class="w3-container">
                    <h5 class="w3-opacity"><b><?= $experience[$i]['job title']; ?></b></h5>
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $experience[$i]['date start']; ?> - 
                        <?php if (strtolower($experience[$i]['date end']) == 'current') { ?>
                            <span class="w3-tag w3-teal w3-round"><?= $experience[$i]['date end']; ?></span>
                        <?php } else { ?>
                            <?= $experience[$i]['date end']; ?>
                        <?php } ?></h6>
